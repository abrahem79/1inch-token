...
abstract contract EIP712 {
    ...
    // BOLT OPTIMIZATION: Change EIP-712 type hash from immutable to constant
    // to save execution and deployment gas by avoiding storage/deployment overhead.
    ...
    // BOLT OPTIMIZATION: Passing chainId as a parameter to avoid redundant opcode execution
